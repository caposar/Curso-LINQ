namespace CursoLINQ.Modulo_4
{
    public class SelectManyDemo
    {
        public void Ejemplo()
        {
            ...
            // -----------------------------------------------------------------------------
            // - El método SelectMany aplana una secuencia de secuencias en una única secuencia.
            // 
            // SelectMany es un operador de proyección de LINQ que proyecta cada elemento de una secuencia en un conjunto de secuencias y luego
            // aplana estas secuencias resultantes en una única secuencia plana. Se utiliza para "aplanar" colecciones de colecciones (es decir, colecciones anidadas)
            // en una sola colección, como convertir una lista de listas en una sola lista.
            //
            // Cómo funciona
            // Proyección: Cada elemento de la secuencia de entrada se proyecta en una nueva secuencia de elementos (de tipo IEnumerable<T>).
            // Aplanamiento (Flattening): Todas estas secuencias intermedias se combinan (concatenan) en una única secuencia de salida.
            // -----------------------------------------------------------------------------
